...
export function VersionBanner(): ReactNode {
  ...
  return (
    <div
      role="status"
      className="flex items-center justify-center gap-3 border-b border-[oklch(0.85_0.02_60)] bg-[oklch(0.97_0.04_60)] px-6 py-2 text-[12px] text-[oklch(0.32_0.10_60)] dark:border-[oklch(0.32_0.06_60)] dark:bg-[oklch(0.20_0.04_60)] dark:text-[oklch(0.82_0.10_60)]"
    >
